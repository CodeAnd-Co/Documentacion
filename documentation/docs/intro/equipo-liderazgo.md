...
| Architecture Owner  | Daniel Contreras | 🚜Proyecto Tractores     | Documentar la arquitectura del sistema, asegurando un modelo escalable, con al menos un 80% de la fase de análisis completada para el 10 de marzo.   |
...
| Rol                | Nombre                          | Proyecto              | Objetivo                                                                                                                                                                                                                                                                       |
|--------------------|----------------------------------|------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Architecture Owner | Arturo Sánchez Rodríguez         | 👕Proyecto textiles     | Reducir el tiempo de aceptación de los Pull Request por 50%.                                                                                                                                                                                                                  |
...
| Architecture Owner | Rommel Pacheco Hernández         | 🚜Proyecto Tractores    | Asegurar que el socio pueda usar el 90% de las historias con ayuda del manual de usuario.                                                                                                                                                                                     |
...
| Team Lead          | Ian Julián Estrada Castro        | 🚜Proyecto Tractores    | Asegurar que cada miembro del equipo duerma un mínimo de 7 horas. Reducir el tiempo dedicado a la codificación para el final de la iteración 4 en un 10%.                                                                                                                     |
