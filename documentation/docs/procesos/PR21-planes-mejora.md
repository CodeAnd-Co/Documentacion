...
| **Documentación del plan**                   | Elaborar el plan de acción de proceso, incluyendo: infraestructura, objetivos, mejoras a tratar, planificación y seguimiento, recursos, estrategias de pilotaje, riesgos y métodos de medición de eficacia.                       | Equipos de acción de proceso          | **OPF, SP 2.1. MA, SP 1.2**, **PMC, SP 1.1**             |
| **Revisión y negociación**                   | Revisar y negociar el plan de acción con las partes interesadas para asegurar compromiso y viabilidad.                                                                                                                            | Comité de dirección, Grupo de proceso | **OPF, SP 2.1. PPQA, SP 1.1**, **PMC, SP 1.1**           |
