...
| **Documentación de requisitos funcionales** | Crear un documento para cada requisito funcional dentro de las carpetas *documentación/requisitos* de cada proyecto en la Wiki que incluya: nombre y número del requisito, historia de usuario, criterios de aceptación, diagrama de secuencia (si aplica) y mockup/wireframe (si aplica). | Equipo de producto   | **REQM SP1.4** (Mantener la trazabilidad bidireccional de los requisitos). |
