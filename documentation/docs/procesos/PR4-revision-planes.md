...
| **Revisión del Plan de Comunicación**                | Mantener el Plan de Comunicación actualizado y consistente con la realidad actual                                                                                                                   | Todo el equipo         | **PP, SP 2.7** (Planificar la Gestión de los Involucrados) **PMC, SP 1.1**  (Monitorear los Parámetros del Proyecto contra el Plan)                                                                                                                   |
