...
| **Inspección**    | Se hace la revisión del código usando la <u>_[checklist](/docs/guias/standards/Revision-de-codigo.md)_</u>. La inspección debe hacerse por separado. Se hace una lectura del código por cada apartado de la checklist. | Inspectores | **VER SP 2.1** (Preparar las revisiones entre pares), **PPQA SP 1.2** (Evaluar objetivamente los productos de trabajo) |
