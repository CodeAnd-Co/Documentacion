...
| **Comprobacion de gestion datos**                 | Una vez identificadas las partes interesadas, confirmar que la gestion de los datos se adhieren a las <u>_[politicas de gestion de datos](/docs/politicas/gestion-de-datos.md)_.</u>                                                                                                                                                                                          | Product Owner                                | **PP, SP 2.3** (Planificar la gestión de los datos).                                                                                                       |
