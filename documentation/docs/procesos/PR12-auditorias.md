...
|                                | Posteriormente, validar si el elemento está bajo [gestión de configuración](https://docs.google.com/spreadsheets/d/1e73fKSTAhxyPqiPN32u_1mkIyCbzssFc-7Ylfs-HL3w/edit?gid=0#gid=0) [(Política de identificación de elementos de Configuración)](/docs/next/politicas/politica-elementos-de-configuración). Si es así, revisar que la versión del ítem esté actualizada en la [matriz de configuración](https://docs.google.com/spreadsheets/d/1e73fKSTAhxyPqiPN32u_1mkIyCbzssFc-7Ylfs-HL3w/edit?gid=620052691#gid=620052691). | Team Lead / SEPG / Team member | **CM SP 3.2**                                              |
