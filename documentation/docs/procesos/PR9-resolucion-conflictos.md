---
title: ⚔️ | PR9 Resolución de conflictos
sidebar_position: 9
---

# ⚔️ Resolución de conflictos

Este proceso busca identificar, reducir y resolver conflictos dentro del equipo de manera justa, objetiva e imparcial, escalándolos solo cuando sea necesario para mantener un ambiente laboral saludable y productivo.

## 🎯 Objetivo

- Identificar el conflicto, reducir su nivel y resolverlo mediante acuerdos justos, objetivos e imparciales, escalándolo solo en caso de ser necesario.

## 📥 Entradas

1. Incumplimiento de acuerdos de trabajo.
2. Conflicto identificado entre dos o más miembros.
3. Reporte de conflicto que incluya:
...
| -------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------ | --------------------------------------------------------- |
| **Identificación**         | Identificar el nivel de conflicto usando la tabla de niveles. Seguir el paso de acuerdo con el nivel correspondiente.                                                                                                                                    | Involucrados                   | **DAR SP 1.1** (Establecer directrices de evaluación)     |
|                            | Si el conflicto es de nivel 3 o superior, repórtalo en el [formulario de denuncias](https://docs.google.com/forms/d/19Df5kc_mCu_4mvd6VVm3ruveyjp7qQSKUlPtaVSVjMc/viewform?edit_requested=true).                                                          | -                              | **IPM SP 2.3** (Resolver problemas con los interesados)   |
| **Nivel 1**                | Solución colaborativa aplicando las **4 C’s**: Calma, Claridad, Curiosidad y Compromiso.                                                                                                                                                                 | Involucrados                   | **OPD SP 1.7**, **DAR SP 1.4**                            |
...
| **Nivel 2**                | Empoderar a las partes para resolver el problema (_“¿Qué puedes hacer?”_). Realizar actividades de integración.                                                                                                                                          | Program Managers / Team Lead   | **OPD SP 1.7**, **DAR SP 1.4**                            |
| **Nivel 3**                | Recopilar datos objetivos y negociar sin involucrar valores personales en la reunión con el Comité de Ética.                                                                                                                                             | Involucrados / Comité de Ética | **DAR SP 1.5**                                            |
| **Nivel 4**                | Establecer estructuras de seguridad: diplomacia, empatía y negociaciones en la reunión con el Comité de Ética.                                                                                                                                           | Involucrados / Comité de Ética | **DAR SP 1.5**, **IPM SP 2.3**                            |
| **Nivel 5**                | Separar físicamente a los involucrados. Convocar a reunión urgente con el Comité de Ética.                                                                                                                                                               | Involucrados / Comité de Ética | **DAR SP 1.6**                                            |
| **Reporte**                | Si el conflicto se reporta, el Comité de Ética debe:                                                                                                                                                                                                     | Comité de Ética                | **IPM SP 2.3**                                            |
|                            | **Reunión:** Convocar a las partes involucradas.                                                                                                                                                                                                         |                                |                                                           |
|                            | **Empatía:** Describir la situación y los sentimientos generados (_aplicando las 4 C’s_).                                                                                                                                                                |                                |                                                           |
...
|                            | **Escalamiento:** Si no hay acuerdo, escalar según la [tabla de escalamiento](#%EF%B8%8F-tabla-de-escalamiento-del-conflicto).                                                                                                                           |                                | **PPQA 2.1** (Comunicar y resolver las no conformidades.) |
...
## ⬆️ Tabla de escalamiento del conflicto
...
1. Conflicto identificado y clasificado según niveles.
2. Acuerdo de resolución firmado por las partes involucradas.
3. Documentación formal del conflicto y su resolución en el Comité de Ética.
