...
|                                          | Identificar y anotar los interesados (gente que participa o se ve afectada por la métrica) en el repositorio        | Miembros del equipo    | **MA, SP 1.2** (Especificar las medidas)                               |
