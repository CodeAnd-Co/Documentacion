...
| **Métodos de validación**                   | Definir un método de validación y explicar cómo se va a llevar a cabo. Dentro de la matriz se encuentra un ejemplo, para guiarte.                                                                                      | Product Owner                  | **VAL, SP 1.1** , **VAL, SP 1.2** (Seleccionar el entorno)                                                            |
...
| **1.2.4**           | Corregir error ortográfico                        | 22/05/2025 | Mariana Juárez, Sofía Osorio      |
