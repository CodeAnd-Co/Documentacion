...
| **Validación y seguimiento** | Se vuelve a corroborar que se cumpla con la <u>_[checklist de procesos](/documentation/docs/recursos/CL1-Checklist-Procesos.md)_</u>.                                                                                                                                                                                | SEPG de la meta específica relacionada | **PPQA, SP 1.1** (Evaluar objetivamente los procesos), **PPQA, SP 1.2** (Evaluar objetivamente los productos de trabajo)           |
