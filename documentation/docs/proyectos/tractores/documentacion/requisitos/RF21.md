...
|-----------|-------------|--------------------|
|PU-RF21-01|Consulta exitosa| Se muestra el nombre de las formulas y sus paramatros|
|PU-RF21-02|Consulta fallido | No se muestra el nombre de las formulas y sus paramatros|
