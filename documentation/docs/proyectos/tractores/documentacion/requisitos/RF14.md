...
Yo como administrador quiero crear un usuario para permitirle el acceso al sistema y asignarle los permisos correspondientes.
  ...
  **Criterios de Aceptación:**
  ...
  - Si se intenta crear un usuario con una contraseña con una longitud de caracteres menor a 8, se debe mostrar una alerta.
  - Si se intenta crear un usuario con una contraseña con una longitud de caracteres mayor a 512, se debe de mostrar una alerta.
  - Los campos deben de tener contador de caracteres.
