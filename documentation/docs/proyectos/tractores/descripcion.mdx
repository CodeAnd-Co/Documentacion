...
| Nombre                  | Rol         |
| ----------------------- | ----------- |
| Diego Isaac Fuentes Juvera      | Product Owner, UX/UI, Presentation Owner|
| Juan Pablo Chávez Leal          | Team Member, QA, Presentation Owner |
| Rommer Toledo Crespo            | Team Lead |
| Pablo Hazael Hurtado Mireles    | Team Member, UX/UI, Writing Owner |
| Daniel Contreras Chávez         | QA, Architecture Owner, Presentation Owner |
| Daniel Queijeiro Albo           | Team Member, SEPG, Comité de ética |
...
|---------|-------------------------|---------|
| Juan Pablo Chávez Leal | Adición de todo exceptuando "Roles y Responsabilidades" | V1.1 |