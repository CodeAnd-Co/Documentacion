...
### Historia de Usuario
Como usuario, quiero agregar un nuevo tipo de alimento en el sistema, para actualizar y mejorar la alimentación de las larvas y escarabajos según sea necesario.


  **Criterios de Aceptación:**
  - El sistema debe permitir ingresar un nuevo tipo de alimento respectiva descripción y cantidad recomendada.
  - La nueva alimento debe estar disponible en la lista de opciones de alimentación.
  - No se puede ingresar números al registrar el nombre de un alimento.
  - No se puede ingresar caracteres especiales al registrar el nombre de un alimento.
