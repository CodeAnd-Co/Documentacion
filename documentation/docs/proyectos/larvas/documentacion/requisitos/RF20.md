...
Como usuario del sistema, quiero seleccionar las charolas a tamizar y registrar sus datos, para tener un registro y hacer analisis de datos
  ...
  **Criterios de Aceptación:**
  ...
  - Se da un mensaje de exito y se lleva al usuario al menú de charolas si todos los datos se registran correctamente

---

### Diagrama de Secuencia

> *Descripción*: El diagrama de secuencia muestra diferentes casos para cuando el usuario tamiza una charola.
...
| **2.2**             | Complementados criterios de aceptación | 03/06/2025  | Sofía Osorio |