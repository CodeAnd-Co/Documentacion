...
### Historia de Usuario
Como usuario, quiero editar la información general de un tipo de hidratación registrado en el sistema, para actualizar sus características, cantidades recomendadas o cualquier ajuste necesario en la hidratación.
...
| **1.3**             | Diseño de Algoritmos                 | 2/6/2025   | Mariana Juárez  |
