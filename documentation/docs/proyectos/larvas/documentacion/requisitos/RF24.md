...
### Historia de Usuario
Como usuario, quiero editar la información de un tipo de alimento registrado en el sistema, para actualizar sus características, cantidades recomendadas o cualquier ajuste necesario en la alimentación.

  **Criterios de Aceptación:**
  - El sistema debe permitir modificar los datos de un tipo de alimento previamente registrado.
  - Los cambios deben reflejarse de inmediato y actualizarse en los registros históricos.
  - No se puede ingresar números al editar el nombre de un alimento.
  - No se puede ingresar caracteres especiales al editar el nombre de un alimento.
...
| **2.4**             | Se actualizaron criterios de aceptación | 30/5/2025  | Mariana Juárez |