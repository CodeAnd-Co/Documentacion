...
sequenceDiagram
    ...
    alt Consulta exitosa
        ...
        Database-->>Model: resopnse: Datos de la charola
        ...
        Domain-->>ViewModel: resopnse: Datos de la charola
        ViewModel-->>View: response: Datos de la charola
        ...
        ViewModel-->>View: response: Error "Charola no encontrada"
        ...
        ViewModel-->>View: response: Error de red
