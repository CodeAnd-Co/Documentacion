...
> ![Interfaz de eliminar cliente](imagenes/mockupEliminarCliente.png)
> ![Interfaz de confirmación de eliminar cliente](imagenes/mockupEliminarClienteConfirmacion.png)

## **Pruebas Unitarias**

_<u>[Enlace a pruebas RF15 Elimina Usuario](https://docs.google.com/spreadsheets/d/1NLGwGrGA5PVOEzLaqxa8Ts1D_Ng3QzzqNKWJYUzxD-M/edit?usp=sharing)</u>_
