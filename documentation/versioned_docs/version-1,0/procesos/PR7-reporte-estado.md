...
| **Patrones y antipatrones**| Ir a la plantilla de patrones y antipatrones en el PVG de proyecto correspondiente para registrar cuales patrones y antipatrones se han repetido desde la iteración anterior. | Equipos. | Durante la junta. | 
